...
// Using SVG directly to avoid adding 'lucide-react' dependency to the prompt requirements,
// though the prompt allows popular libraries. We'll use SVGs for zero-dep simplicity where possible.
